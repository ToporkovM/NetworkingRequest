...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    var window: UIWindow?
    //переменная которая захватывает значение фоновой активности из метода application
    ...
    func sceneDidEnterBackground(_ scene: UIScene) {
        ...
        //метод для сопостовления идентификатора сессий
